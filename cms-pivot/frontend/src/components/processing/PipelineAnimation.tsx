...
export const AGENT_ARMY_AGENTS = [
  { name: 'Rules Engine Agent', description: 'Validates claims against VA Financial Policy, benefits eligibility, and service connection requirements. Cross-references 38 CFR Title 38 regulations.' },
  ...
  { name: 'Pension Poaching Agent', description: 'Detects predatory providers targeting vulnerable veterans with unsolicited benefit claims. Identifies dual claims for the same service period across multiple providers.' },
  ...
  { name: 'DBQ Fraud Agent', description: 'Analyzes Disability Benefits Questionnaires for fabrication indicators: exam duration anomalies, template manipulation, copy-paste patterns, and inconsistent findings.' },
  ...
  { name: 'Medical Record Agent', description: 'Cross-validates medical codes against clinical documentation using NLP. Detects service-diagnosis mismatches, impossible procedure combinations, and deceased veteran billing.' },
...
export const NODE_DETAIL_SECTIONS: Record<string, NodeDetailSection> = {
  ...
  warehouse: {
    ...
    capabilities: [
      ...
      'Implement data archiving and retention policies per VA records management requirements',
      ...
      'Maintain master indices: veterans, providers, facilities, code references',
      'Support federated queries across VHA, VBA, and NCA data domains',
    ...
    compliance: [
      ...
      'VA Directive 6500 information management',
  ...
  rules_engine: {
    ...
    overview:
      'High-performance rules engine executing over 1,000 configurable compliance rules in real-time. Applies CMS Correct Coding Initiative (CCI) edits, Prospective Payment System (PPS) logic, VA Financial Policy rules, and fee schedule rate validations to every claim.',
    capabilities: [
      ...
      'Validate against Medicare Physician Fee Schedule (MPFS) and VA Fee Schedule rates',
      'Enforce VA Financial Policy rules including benefits eligibility and service connection verification',
      'Modifier validation: -25, -59, -76, -77, -XE, -XP, -XS, -XU and VA-specific modifiers',
    ...
    compliance: [
      ...
      'VA VHA Directive 1030 claims processing standards',
      'Medicare Claims Processing Manual (Pub 100-04)',
      'CFR Title 38 Veterans Benefits regulations',
    ],
  },
  agent_army: {
    ...
    capabilities: [
      ...
      'Detect deceased veteran billing and identity theft schemes',
      'Pension poaching: identify predatory providers targeting vulnerable veterans',
      'Claim sharking: detect unsolicited contact and high-volume suspicious filing patterns',
      'DBQ fraud: flag exam duration anomalies, template manipulation, fabricated questionnaires',
    ...
    compliance: [
      ...
      'VA Directive 0008 AI/ML governance',
  ...
  decision_routing: {
    ...
    capabilities: [
      ...
      'Integration with VA debt management and Treasury offset programs',
    ...
    compliance: [
      '38 CFR 1.900-1.953 debt collection',
      'VA Directive 4860 debt management',
