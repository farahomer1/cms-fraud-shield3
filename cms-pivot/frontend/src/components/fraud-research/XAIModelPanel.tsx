...
const featureImportanceData = [
  ...
  { feature: 'Veteran Deceased Status', shap_value: 0.28, direction: 'fraud' as const },
  ...
  { feature: 'Veteran Service History', shap_value: -0.22, direction: 'legitimate' as const },
];
...
const unflaggedPredictions: UnflaggedPrediction[] = [
  {
    ...
    provider_name: 'Tampa Bay Veterans Services',
  ...
  },
  {
    ...
    veteran_name: 'Robert L. Chen',
    provider_name: 'Orlando Veteran Care LLC',
  ...
  },
  {
    ...
    veteran_name: 'William K. Thompson',
    provider_name: 'Pensacola Veterans Aid Group',
  ...
  },
  {
    ...
    veteran_name: 'Michael J. Anderson',
...
const waterfallData = [
  ...
  { feature: 'Veteran History', value: -0.04, cumulative: 0.77, fill: '#2E8540' },
              ...
              {unflaggedPredictions.map((row) => (
                <React.Fragment key={row.claim_id}>
                  ...
                  >
                    ...
                    <TableCell>
                      <Typography variant="body2" sx={{ fontSize: '0.8rem' }}>{row.veteran_name}</Typography>
                    </TableCell>
                    <TableCell>
                          ...
                          <CardContent sx={{ py: 1.5, '&:last-child': { pb: 1.5 } }}>
                            ...
                            <Stack spacing={0.75}>
                              {[
                                ...
                                { feature: 'Veteran History', value: -(row.feature_contribution * 0.2), color: '#2E8540' },
                              ].map((item) => (
