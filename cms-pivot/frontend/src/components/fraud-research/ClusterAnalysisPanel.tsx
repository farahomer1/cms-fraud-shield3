...
const clusters: ClusterDef[] = [
  {
    ...
    description: 'Providers with abnormally high billing amounts concentrated in Tampa/Orlando area, many sharing the same veterans.',
    silhouette_score: 0.82,
  },
  {
    id: 'C2',
    label: 'Deceased Veteran Claims',
    color: '#9C27B0',
    member_count: 18,
    avg_risk: 92,
    dominant_fraud_type: 'Identity Fraud',
    description: 'Claims filed for veterans with confirmed deceased status, originating from 3 provider organizations.',
  ...
  },
  {
    ...
    description: 'Claims where the provider location is far from the veteran\'s residence, suggesting potential kickback schemes.',
    silhouette_score: 0.68,
  },
  {
    id: 'C5',
    label: 'DBQ Pattern Cluster',
    color: '#2196F3',
    member_count: 29,
    avg_risk: 76,
    dominant_fraud_type: 'DBQ Fraud',
    description: 'Disability benefit questionnaires with suspicious similarity scores, suggesting template-based fraud.',
        ...
        <Paper variant="outlined" sx={{ p: 2.5, borderRadius: 2 }}>
          ...
          <ResponsiveContainer width="100%" height={400}>
            <RadarChart data={radarData}>
              ...
              <Radar name="Deceased Veterans" dataKey="C2" stroke="#9C27B0" fill="#9C27B0" fillOpacity={0.1} strokeWidth={2} />
              <Radar name="Rapid Submitters" dataKey="C3" stroke="#FF5722" fill="#FF5722" fillOpacity={0.1} strokeWidth={2} />
              <Radar name="DBQ Pattern" dataKey="C5" stroke="#2196F3" fill="#2196F3" fillOpacity={0.1} strokeWidth={2} />
