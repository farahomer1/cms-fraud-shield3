...
const ALL_AGENT_DEFINITIONS: {
  ...
  },
  {
    ...
    pass_evidence:
      'Veteran vital status confirmed. SSN last-4 validated. Provider NPI verified in NPPES registry.',
  },
  {
    name: 'Pension Poaching Agent',
    fraud_type: 'pension_poaching',
    pass_evidence:
      'No indicators of asset manipulation detected. Benefit claim amounts are consistent with veteran disability rating.',
  },
  {
  ...
  {
    name: 'DBQ Fraud Agent',
    fraud_type: 'dbq_fraud',
    pass_evidence:
      'DBQ responses consistent with documented medical condition. Completion time within normal range.',
  },
  {
    name: 'Overlapping Claim Agent',
    fraud_type: 'overlapping_claims',
    pass_evidence:
      'Service dates and procedure codes are unique across all claims for this veteran. No double-billing detected.',
  },
  {
