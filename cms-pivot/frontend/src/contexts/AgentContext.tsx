...
const SEED_AGENTS: PipelineAgent[] = [
  ...
  },
  {
    id: 'agent-dbq-fraud',
    name: 'DBQ Fraud',
    description: 'Detects fraudulent Disability Benefits Questionnaire submissions.',
    type: 'rule-based',
    definition: 'Flag claims where the DBQ was completed by a provider who is not accredited or where the exam date does not match VA scheduling records.',
    status: 'testing',
