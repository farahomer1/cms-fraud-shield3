...
const SEED_WORKFLOWS: AuditorWorkflow[] = [
  ...
  },
  {
    ...
    dataSources: ['npi_registry', 'va_claims_db', 'bigquery'],
    createdBy: 'Sarah Mitchell',
  ...
  {
    id: 'wf-pact-act-compliance',
    name: 'PACT Act Compliance Review',
    description:
      'Reviews claims processing accuracy for PACT Act-eligible veterans, ensuring toxic exposure claims are handled per updated VA guidelines.',
    category: 'compliance_review',
    status: 'active',
    steps: [
      { id: 's1', name: 'Identify PACT Act Claims', type: 'data_collection', description: 'Filter claims related to PACT Act presumptive conditions', config: { source: 'bigquery', filter: 'pact_act' }, order: 1 },
      { id: 's2', name: 'Eligibility Verification', type: 'compliance_check', description: 'Verify veteran eligibility under PACT Act provisions', config: { ruleSet: 'pact_act' }, order: 2 },
      ...
      { id: 's5', name: 'Generate Report', type: 'report_generation', description: 'Produce PACT Act compliance report', config: { format: 'pdf' }, order: 5 },
    ],
    schedule: { enabled: false, cron: '0 6 1 */3 *', timezone: 'America/New_York', nextRun: null, lastRun: '2026-01-01T06:00:00Z' },
    dataSources: ['bigquery', 'va_claims_db', 'medical_records'],
    createdBy: 'James Rodriguez',
    createdAt: '2025-12-01T08:00:00Z',
    updatedAt: '2026-01-10T09:00:00Z',
    lastRunAt: '2026-01-01T06:00:00Z',
    runCount: 2,
    tags: ['PACT Act', 'compliance', 'toxic exposure'],
  },
  {
