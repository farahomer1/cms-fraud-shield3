...
function generateFallbackLogs(category: string): LogEntry[] {
  ...
  const messages: Record<string, string[]> = {
    ...
    ai_agent: [
      ...
      'Data Validation Integrity agent completed: confidence 97.3%',
      'Threat Simulation "Trust Defender" execution: 2 suspicious enrollment patterns found',
      'Pre-Payment Claims Hold "Crush Fraud" agent: provider cross-reference complete',
      'Enrollment Audit & Unmasking "System Resilience" agent: ownership graph simulation anomaly detected',
      'Overlapping Claims check: 0 conflicts found',
      'Program Integrity Ops agent: DOJ referral dossier compiled',
      'Rules Engine: statutory quantity limits verified',
      'Gemini API call: 1,847ms latency, 2,340 tokens',
      'Agent pipeline completed for batch BTH-2024-0412 (87 claims)',
    ],
    audit: [
      'User admin@cms.hhs.gov logged in from 10.0.0.42',
      ...
      'Export requested: analytics report by admin@cms.hhs.gov',
