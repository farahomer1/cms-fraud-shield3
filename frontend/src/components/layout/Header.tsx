  ...
  return (
    ...
    >
      <Toolbar>
        ...
        <Typography variant="h6" component="span" fontWeight="bold" sx={{ flexGrow: 0, mr: 1, letterSpacing: 1.2 }}>
          CMS Fraud Shield
        </Typography>
        <Typography variant="body2" sx={{ opacity: 0.7, flexGrow: 1 }} aria-label="Adversarial Modeling &amp; Red-Teaming Platform">
