...
const DATA_SOURCES: DataSource[] = [
  ...
  { id: 'vba_master', name: 'VBA Master Record', description: 'Members Benefits Administration master index', icon: <BadgeIcon />, color: '#2E8540' },
  { id: 'vbms', name: 'VBMS', description: 'Members Benefits Management System', icon: <AccountBalanceIcon />, color: '#8B6914' },
