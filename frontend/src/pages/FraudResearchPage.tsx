...
import { DMELoopholeSimulator } from '../components/fraud-research/DMELoopholeSimulator';
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          ...
          >
            ...
            <Tab icon={<SecurityIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="DME Loophole Simulator" />
          </Tabs>
        </Box>
