...
const ROLE_OPTIONS: { value: UserRole; label: string; color: string }[] = [
  { value: 'Enrollment Analyst', label: 'Enrollment Analyst', color: '#112E51' },
  { value: 'Senior Investigator', label: 'Senior Investigator', color: '#E31C3D' },
  { value: 'Platform Administrator', label: 'Platform Administrator', color: '#2E8540' },
];
...
const SEED_USERS: SystemUser[] = [
  {
    ...
    updatedAt: daysAgo(2),
    mfaEnabled: true,
    notes: 'Lead case officer — CMS system administrator.',
  },
  {
    id: 'u-002',
    firstName: 'Maria',
    ...
    mfaEnabled: true,
    notes: 'Senior program integrity division investigator.',
  },
  {
    id: 'u-003',
    firstName: 'James',
  ...
  },
  {
    ...
    mfaEnabled: true,
    notes: 'OIG liaison for program audits.',
  },
  {
    id: 'u-005',
    firstName: 'Robert',
    ...
    updatedAt: daysAgo(1),
    mfaEnabled: true,
    notes: 'Senior program integrity investigator — manages access control and integrations.',
  },
  {
    id: 'u-006',
    firstName: 'Linda',
  ...
  },
  {
    ...
    updatedAt: daysAgo(7),
    mfaEnabled: true,
    notes: 'Regional IT administrator and platform administrator.',
  },
];
